...
## 💼 Work Status & Availability in Japan
* **Visa Status:** Student Visa with **Part-time Work Permit** (資格外活動許可あり)
* **Weekly Limit:** Up to **28 hours per week** (Can work up to 40 hours during official university breaks)
...
### 🎮 [GameHub](https://github.com/ABHINAV1447/gamehub) (React + TypeScript)
* A modern video game discovery and search platform.
* **Tech Stack:** React, TypeScript, Zustand (State Management), Chakra UI, Axios, RAWG API.
* **Key Features:** Real-time search, filters by platform/genre, dark mode, loading skeletons, infinite scroll.

### 📅 [Habit Tracker](https://github.com/ABHINAV1447/Habit-tracker) (MERN Stack)
